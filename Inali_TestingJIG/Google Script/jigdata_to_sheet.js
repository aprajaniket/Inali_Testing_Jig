var SS = SpreadsheetApp.openById(
  "16uY9erxcQGG-M64O9CLI6__HWi0BVnOLM597bPmeO8I"
);
var str = "";
...
function doPost(e) {
  ...
  if (parsedData !== undefined) {
    ...
    var estimated_value = dataArr[4];
    var estimated_value_y = dataArr[5];
    var estimated_value_z = dataArr[6];
    ...
    switch (parsedData.command) {
      case "insert_row":
        ...
        sheet.getRange("I2").setValue(estimated_value);
        sheet.getRange("J2").setValue(estimated_value_y);
        sheet.getRange("K2").setValue(estimated_value_z);
      ...
      case "append_row":
        ...
        publish_array[6] = estimated_value;
        publish_array[7] = estimated_value_y;
        publish_array[8] = estimated_value_z;
